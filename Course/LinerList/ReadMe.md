- [2.线性表](#2---)
  ...
  * [2.3 线性表的链式表示](#23---------)
    ...
    + [2.3.3 双链表](#233----)
      - [2.3.3.1 初始化](#2331----)
      - [2.3.3.2 判空](#2332---)
      - [2.3.3.3 双链表的头插和尾插法操作](#2333-------------)
      - [2.3.3.4 双链表的插入操作](#2334---------)
      - [2.3.3.5 双链表的删除操作](#2335---------)
      - [2.3.3.6 双链表的销毁操作](#2336---------)
      - [2.3.3.7 双链表的遍历操作](#2337---------)
    + [2.3.4 循环链表](#234-----)
      - [2.3.4.1 循环单链表](#2341------)
        * [1.初始-判空-插入-打印](#1-----------)
      - [2.3.4.2 循环双链表](#2342------)
        * [1.##### 1.初始-判空-是否是表尾结点-插入-删除-遍历](#1------1----------------------)
    + [2.3.5 静态链表](#235-----)
